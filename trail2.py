...
with st.sidebar:
    ...
    models_info = [
        {"name": "Naive Bayes",         "acc": "90%", "err": "Low Error Rate",     "cls": "model-nb",  "color": "#60a5fa"},
        {"name": "Logistic Regression", "acc": "93%", "err": "Very Low Error Rate","cls": "model-lr",  "color": "#34d399"},
        {"name": "SVM",                 "acc": "99%", "err": "Minimal Error Rate", "cls": "model-svm", "color": "#f472b6"},
    ]
    ...
    st.markdown('<p style="font-size:0.82rem; color:#94a3b8; line-height:1.6;">AI-powered chatbot trained on college admission FAQs. Switch models above to compare performance.</p>', unsafe_allow_html=True)
